...
%                     disp('jump 2');
				...
				dL = ( pImage_CIELab(Iy,Ix,1)-pImage_CIELab(seed_y,seed_x,1) )^2;
				da = ( pImage_CIELab(Iy,Ix,2)-pImage_CIELab(seed_y,seed_x,2) )^2;
				db = ( pImage_CIELab(Iy,Ix,3)-pImage_CIELab(seed_y,seed_x,3) )^2;
...
%  					disp([Iy,Ix])
                    ...
                    newL(Iy,Ix,1)=pImage_CIELab(Iy,Ix,1);
                    newL(Iy,Ix,2)=pImage_CIELab(Iy,Ix,2);
                    newL(Iy,Ix,3)=pImage_CIELab(Iy,Ix,3);
                else
